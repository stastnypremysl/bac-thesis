...
\def\ThesisTitle{Command-line tool \icode{lsql-csv} for CSV files processing}
...
\def\Keywords{%
  {relational database}, {CSV}, {SQL}, {Haskell}, {query language}, {Unix philosophy}, {lsql-csv}, {LSQL}
}
