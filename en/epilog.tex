...
The \icode{lsql-csv} has been uploaded to the Hackage public package repository and therefore is easily installable. 
It provides automatic Haddock documentation, which is browseable from there. 
It has also been published on GitHub with \icode{README.md} file containing the full user documentation including the tutorial and grammar description.
