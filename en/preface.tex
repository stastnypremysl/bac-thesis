...
Despite that, there are some implementations of SQL (eg. \icode{q} \cite{q}, \icode{CSV SQL} \cite{csv-sql}, \icode{trdsql} \cite{trdsql} or \icode{csvq} \cite{csvq}), which tries to implement SQL on CSV files.
