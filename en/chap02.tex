...
\begin{itemize}
    ...
    \item \icode{Lsql.Csv.Core.Evaluator} -- This module contains the evaluator of \break\icode{lsql-csv} program.
    ...
    \item \icode{Lsql.Csv.Lang.BlockChain} -- This module contains a main parser of blo\-cks other than the from block.
...
The function first calls preprocesor in \icode{Lsql.Csv.Lang.BlockSeparator}, which splits command into list of strings. Then \icode{SymbolMap} with input is loaded using \icode{Lsql.\allowbreak Csv.Lang.From.Block} and after that
rest of blocks are parsed using \icode{Lsql.\allowbreak Csv.\allowbreak Lang.\allowbreak BlockChain}. Program is then evaluated using
\icode{Lsql.\allowbreak Csv.Core.Evaluator} and finally output generated by \icode{Lsql.\allowbreak Csv.Utils.CsvGenerator}.
