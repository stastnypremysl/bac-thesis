...
The function first calls preprocesor in \icode{Lsql.Csv.Lang.BlockSeparator}, which splits command into list of strings. Then \icode{SymbolMap} with input is loaded using \break\icode{Lsql.Csv.Lang.From.Block} and after that
rest of blocks are parsed using \break\icode{Lsql.Csv.Lang.BlockChain}. Program is then evaluated using
\break\icode{Lsql.Csv.Core.Evaluator} and finally output generated by \break\icode{Lsql.Csv.Utils.CsvGenerator}.
